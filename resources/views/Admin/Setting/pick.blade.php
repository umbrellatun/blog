                           ...
                           <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                     <div class="modal-header">
                                          <h5 class="modal-title h4" id="mySmallModalLabel">ค่าหยิบ</h5>
                      ...
                      <div class="row">
                           <div class="col-md-6 col-xl-3">
                                <div class="card bg-c-blue">
                                     <div class="card-body">
                                          <h5 class="text-white">ค่าหยิบ</h5>
                                          <h5 class="text-white"><span class="float-right">{{number_format($setting->price, 2)}} THB</span></h5>
                                          <div class="text-center">
                                               <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fas fa-cog"></i></button>
                                          </div>
                                     </div>
                                </div>
                           </div>
                 ...
                 $.ajax({
                     ...
                     if (rec.status == 1) {
                          swal("", rec.content, "success").then(function(){
                               window.location.href = "{{ route('ratepick') }}";
                          });
                     } else {
